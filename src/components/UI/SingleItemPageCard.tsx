      ...
      <div className="flex flex-col xl:flex-row">
        <div className="">
          <img
            ...
            className="w-[350px]"
          />
          <div className="flex md:w-[350px] justify-center mt-1">
            <img
              src={foundItem.image}
              alt="single-item-image"
              className="w-[60px] object-cover hover:scale-75 duration-300"
            />{" "}
            <img
              src={foundItem.image}
              alt="single-item-image"
        ...
        <div className="flex flex-col xl:ml-10 py-4 xl:py-0 md:w-[600px]">
        ...
        <div className="marquee">
          <div className={`maylike-products-container track`}>
            {otherItems.map((singleItem: Clothe) => {
              return (
                <div
                  className="mt-10 hover:scale-110 duration-300 px-6"
                  key={singleItem.id}
                >
